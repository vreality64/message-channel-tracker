(() => {
    ...
    window.addEventListener("message", (event) => {
        ...
        try {
            ...
            if (typeof t === "string" && t.startsWith("MCT:"))
                return;
            const titlePairs = [
    ...
    (function wrapPostMessage() {
        ...
        if (!original || original.__MCT_WRAPPED__)
            return;
    ...
    (function wrapMessagePort() {
        ...
        if (!PortProto)
            return;
        if (PortProto.postMessage?.__MCT_WRAPPED__)
            return;
    ...
    (function wrapMessageChannel() {
        ...
        if (!OriginalMC || OriginalMC.__MCT_WRAPPED__)
            return;
    ...
    (function wrapBroadcastChannel() {
        ...
        if (!OriginalBC || OriginalBC.__MCT_WRAPPED__)
            return;
