...
const mctStyles = {
    ...
    arrowOut: "color:#22c55e;font-weight:700;background:#ffffff;border:1px solid #e5e7eb;padding:0 4px;border-radius:6px;",
    arrowIn: "color:#ef4444;font-weight:700;background:#ffffff;border:1px solid #e5e7eb;padding:0 4px;border-radius:6px;",
    arrowPort: "color:#a855f7;font-weight:700;background:#ffffff;border:1px solid #e5e7eb;padding:0 4px;border-radius:6px;",
    meta: "color:#64748b;",
};
...
function mctOpenGroup(op, message) {
...
(function setupMctConsoleCapture() {
    ...
    function renderStyledLine(fmt, rest) {
        ...
        const pushText = (text) => {
            ...
            if (currentStyle)
                span.setAttribute("style", String(currentStyle));
            p.appendChild(span);
        };
        let i = 0;
        while (i < fmt.length) {
